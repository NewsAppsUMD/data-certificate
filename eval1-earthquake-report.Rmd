---
title: "Eval: Earthquake Report"
---
```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE)
```

This notebook fetches earthquake data from USGS, updates a local dataset, and generates automated reports for significant earthquakes.
...
1. A minimum magnitude (e.g., 4.0, 4.5, 5.0)
2. A location to search for (e.g., "California", "Alaska", "Japan", "Indonesia", "Mexico")
3. A time period in days (e.g., 1, 3, 7, 14)
